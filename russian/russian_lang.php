...
# Version 2.0.1
$lang['company_logo_dark']                                      = 'Темное лого компании';
$lang['customers_register_require_confirmation']                = 'Требуется подтверждение регистрации от администратора после регистрации клиента';
$lang['customer_requires_registration_confirmation']            = 'Требуется подтверждение регистрации';
$lang['confirm_registration']                                   = 'Подтвердите регистрацию';
$lang['customer_registration_successfully_confirmed']           = 'Регистрация клиента успешно подтверждена';
$lang['customer_register_account_confirmation_approval_notice'] = 'Спасибо за регистрацию, ваша учетная запись ожидает одобрения и будет подтверждена в ближайшее время.';
$lang['after_subscription_payment_succeeded'] = 'AПосле успешной оплаты подписки';
...
$lang['gdpr_not_enabled'] = 'GDPR не включено';
$lang['enable_gdpr'] = 'Включить GDPR';
$lang['gdpr_right_to_rectification'] = 'Право на исправление';
$lang['test_sms_config'] = 'Тестовая конфигурация СМС';
$lang['test_sms_message'] = 'Тестовое сообщение';
$lang['send_test_sms'] = 'Отправить тестовое СМС';
$lang['gdpr_short'] = 'GDPR';
$lang['allow_non_admin_staff_to_delete_ticket_attachments'] = 'Разрешить сотрудникам, не являющимся администраторами, удалять вложения тикетов';

# Version 2.1.0
$lang['contract_number']                                = 'Контактный номер';
$lang['project_changing_status_recurring_tasks_notice'] = 'Вы меняете статус на {0}, все повторяющиеся задачи будут отменены';
$lang['not_contract_signed']                            = 'Договор с темой %s был подписан заказчиком';
$lang['the_number_sign']                                = '#';
$lang['not_new_ticket_reply']                           = 'Клиент ответил на тикет - %s';
$lang['receive_notification_on_new_ticket_replies']     = 'Получать уведомления при ответе клиента на тикет';
$lang['receive_notification_on_new_ticket_reply_help']  = 'Все сотрудники, которые принадлежат к отделу технической поддержки, получат уведомление, когда клиент ответит на тикет';
...
$lang['contract_add_note']                              = 'Добавить примечание';
...
$lang['expense_subtract_info_text']                                  = 'Используйте эту опцию, чтобы вычесть общую сумму налога из суммы расходов, полезно, когда вы ввели сумму расходов с включенным налогом (включая налог).';
...
$lang['total_items_deleted']                                         = 'Всего удалено позиций: %s';
$lang['billable_amount']                                             = 'Оплачиваемая сумма';
$lang['last_child_invoice_date']                                     = 'Дата последнего дочернего счета';
$lang['good_morning']                                                = 'Доброе утром';
$lang['good_afternoon']                                              = 'Доброго дня';
$lang['good_evening']                                                = 'Доброго вечера';
$lang['description_in_invoice_item']                                 = 'Включить описание для позиции счета';
...
$lang['email_verification_required']                                 = 'Требуется подтверждение электронной почты';
$lang['email_verification_required_message']                         = 'Для того чтобы получить доступ ко всем доступным функциям портала, сначала необходимо подтвердить свою электронную почту.';
$lang['email_verification_required_message_mail']                    = 'Мы отправили вам электронное письмо с инструкциями для подтверждения, если вы еще не получили письмо, пожалуйста, проверьте папку спама или нажмите <a href="%s">здесь</a> чтобы повторно отправить.';
$lang['email_already_verified']                                      = 'Ваша электронная почта уже подтверждена';
$lang['invalid_verification_key']                                    = 'Неверный проверочный ключ';
$lang['verification_key_expired']                                    = 'Истек срок действия проверочного ключа';
$lang['email_successfully_verified']                                 = 'Ваша электронная почта была успешно подтверждена.';
$lang['email_successfully_verified_but_required_admin_confirmation'] = 'Ваша электронная почта была успешно проверена, вы сможете войти в систему после того, как администратор подтвердит вашу учетную запись вручную.';
$lang['email_verification_mail_sent_successully']                    = 'Мы отправили вам электронное письмо с инструкциями для подтверждения';
$lang['create_reminder']                                             = 'Создать напоминание';
$lang['no_reminders_for_this_task']                                  = 'Нет напоминаний для этой задачи';
$lang['reminder_for']                                                = 'Напоминание для %s на %s';
$lang['no_description_provided']                                     = 'Описание не предоставлено';
$lang['pay_with_card']                                               = 'Оплата картой';
$lang['not_customer_uploaded_file']                                  = 'Файл(ы) загружены в профиль';

# Version 2.2.1
$lang['customer_files_info_message'] = 'Файлы из проектов и задач, связанных с заказчиком, в этой таблице не отображаются.';
$lang['ticket_import_reply_only'] = 'Попробовать импортировать только актуальный ответ на тикет (без цитируемого/перенаправленного сообщения)';
$lang['learn_more'] = 'Узнать больше';
$lang['sales_item']                  = 'Позиция';
...
# Version 2.3.2
$lang['create_recurring_from_child_error_message'] = 'Вы не можете установить %s как повторяющийся, потому что %s является дочерним от другого повторяющегося %s.';
$lang['statement_credit_note_refund']              = 'Возврат кредита - %s';
$lang['no_validation']                             = 'Нет проверкиn';
...
# Version 2.3.5
$lang['tags_update_replace_warning'] = 'Некоторые теги не обновляются, поскольку имя тега уже существует';
$lang['attach_statement']            = 'Прикрепить заявление клиента';
...
$lang['subscription_incomplete']          = 'Не завершена';
$lang['subscription_incomplete_expired']  = 'Не завершена и истекла';
$lang['credit_card_short']                = 'Карта';
$lang['webhook_created']                  = 'Вебхук создан успешно.';
$lang['subscriptions_terms_info']         = 'Введите правила и условия использования, которые будут отображаться клиенту перед подпиской.';
$lang['subscription_complete_payment']    = 'Оплата подписки';
$lang['subscription_is_subscription_is_expired'] = 'Подписка уже истекла.';
$lang['subscription_plan_currency_does_not_match'] = 'Выбранная валюта тарифа не соответствует валюте, выбранной ниже.';
...
# Version 2.4.1
$lang['contract_content_permission_edit_warning'] = 'Ваши текущие разрешения не позволяют вам редактировать содержимое договора. Проконсультируйтесь с администратором, чтобы получить разрешение на редактирование договоров.';
$lang['mark_as_signed']                 = 'Пометить как подписанный';
$lang['unmark_as_signed']               = 'Снять пометку о подписи';
$lang['marked_as_signed']               = 'Помечено как подписанное';
$lang['contract_marked_as_signed_info'] = 'Этот контракт вручную помечен как подписанный.';
$lang['save_and_send_later']            = 'Сохранить и отправить позже';
$lang['schedule']                       = 'Планирование';
$lang['schedule_email_for']             = 'Запланировать письмо для %s';
$lang['schedule_date']                  = 'Когда вы хотите отправить письмо?';
$lang['email_scheduled_successfully']   = 'Почта запланирована успешно';
$lang['invoice_will_be_sent_at']        = 'Счет будет отправлен %s';
