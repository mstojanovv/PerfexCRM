...
$lang['client_delete_tooltip'] = 'Все данные клиента будут удалены. Договоры,тикеты,примечания. Примечание: Если клиент имеет счета, то он не будет удален. Вам нужно назначить эти счета другому клиенту, чтобы сохранить номер счета';
$lang['client_firstname'] = 'Имя';
$lang['client_lastname'] = 'Фамилия';
$lang['client_email'] = 'Email';
$lang['client_company'] = 'Заказчик';
...
$lang['kb_group_add_edit_note'] = 'Примечание: Все статьи в этой группе будут скрыты, если отметить флажок "Откл."';
$lang['group_table_name_heading'] = 'Название';
$lang['group_table_isactive_heading'] = 'Активно';
$lang['kb_no_groups_found'] = 'Группы не найдены';

# Mail Lists
$lang['mail_lists'] = 'Рассылки';
$lang['mail_list'] = 'Рассылка';
$lang['new_mail_list'] = 'Новая рассылка';
$lang['mail_list_lowercase'] = 'рассылка';
$lang['custom_field_deleted_success'] = 'Произвольное поле удалено';
$lang['custom_field_deleted_fail'] = 'Не удалось удалить поле';
$lang['email_removed_from_list'] = 'Email удален из списка';
$lang['email_remove_fail'] = 'Не удалось удалить Email из списка';
$lang['staff_mail_lists'] = 'Рассылка сотрудникам';
$lang['clients_mail_lists'] = 'Рассылка клиентам';
$lang['mail_list_total_imported'] = 'Всего импортировано: %s';
$lang['mail_list_total_duplicate'] = 'Всего дубликатов: %s';
$lang['mail_list_total_failed_to_insert'] = 'Не удалось вставить адреса електронной почты: %s';
$lang['mail_list_total_invalid'] = 'Неверные адреса электронной почты: %s';
$lang['cant_edit_mail_list'] = 'Вы не можете редактировать этот список, этот список заполняется автоматически';
$lang['mail_list_add_edit_name'] = 'Название рассылки';
$lang['mail_list_add_edit_customfield'] = 'Добавить произвольное поле';
$lang['mail_lists_view_email_email_heading'] = 'Email';
$lang['mail_lists_view_email_date_heading'] = 'Дата добавления';
$lang['add_new_email_to'] = 'Добавить новый Email в %s';
$lang['import_emails_to'] = 'Импорт адресов эл. почты в %s';
$lang['mail_list_new_email_edit_add_label'] = 'Email';
$lang['mail_list_import_file'] = 'Импортировать файл';
$lang['mail_list_available_custom_fields'] = 'Доступные произвольные поля';
$lang['submit_import_emails'] = 'Импорт адресов эл. почты';
$lang['btn_import_emails'] = 'Импорт адресов эл. почты (Excel)';
$lang['btn_add_email_to_list'] = 'Добавить Email в этот список';
$lang['mail_lists_dt_list_name'] = 'Название списка';
$lang['mail_lists_dt_datecreated'] = 'Дата создания';
$lang['mail_lists_dt_creator'] = 'Автор';
$lang['email_added_to_mail_list_successfully'] = 'Email добавлен в список';
$lang['email_is_duplicate_mail_list'] = 'Email уже существует в списке';
...
$lang['survey_no_mail_lists_selected'] = 'Не выбрана рассылка';
$lang['survey_send_success_note'] = 'Все опросы(%s) будут отправлены через CRON';
$lang['survey_result'] = 'Результат опроса: %s';
$lang['question_string'] = 'Вопрос';
$lang['question_field_string'] = 'Поле';
$lang['survey_list_view_tooltip'] = 'Просмотр';
$lang['survey_list_view_results_tooltip'] = 'Результаты';
$lang['survey_add_edit_subject'] = 'Тема опроса';
$lang['survey_add_edit_email_description'] = 'Описание (Описание письма)';
$lang['survey_include_survey_link'] = 'Включить ссылку в описание';
$lang['survey_available_mail_lists_custom_fields'] = 'Доступные пользовательские поля из списков рассылки';
$lang['survey_mail_lists_custom_fields_tooltip'] = 'Пользовательские поля могут быть использованы для редактора писем.';
$lang['survey_add_edit_short_description_view'] = 'Краткое описание (Описание при просмотре)';
$lang['survey_add_edit_from'] = 'Отправитель (отображается в письме)';
$lang['survey_add_edit_redirect_url'] = 'Ссылка перенаправления';
$lang['survey_add_edit_red_url_note'] = 'После завершения заполнения опроса пользователь будет перенаправлен (оставьте пустым, что перенаправить на этот сайт)';
$lang['survey_add_edit_disabled'] = 'Отключено';
$lang['survey_add_edit_only_for_logged_in'] = 'Только для зарегистрированных участников (сотрудники,клиенты)';
...
$lang['survey_send_mail_lists_note_logged_in'] = 'Примечание: Если вы отправляете опрос через рассылку, то отметку с опции Только для зарегистрированных участников нужно снять';
$lang['survey_send_string'] = 'Отправить';
$lang['survey_send_to_total'] = 'Отправлено всего писем %s';
...
$lang['survey_field_radio'] = 'Радиокнопка';
$lang['survey_field_input'] = 'Текстовое поле';
...
$lang['task_no_assignees'] = 'Исполнители отсутствуют для этой задачи';
$lang['task_no_followers'] = 'Наблюдатели отсутствуют для этой задачи';
...
# Home
$lang['clients_quick_invoice_info'] = 'Информация о счетах';
...
# Customers
$lang['client_delete_invoices_warning'] = 'У этого клиента есть счета и сметы в аккаунте. Вы не можете удалить этого клиента. Укажите эти сметы для др. клиента, перед удалением текущего клиента.';
...
$lang['goal_notify_when_achieve'] = 'Уведомить сотрудников, когда цель достигнута';
...
$lang['goal_notify_when_end_date_arrives'] = 'Сотрудники будут уведомлены, в дату окончания (Необходим CRON).';
...
$lang['goal_notify_staff_notified_manually_success'] = 'Сотрудники будут уведомлены о результатах достижения цели';
$lang['goal_notify_staff_notified_manually_fail'] = 'Не удалось уведомить сотрудников о результатах цели';
...
$lang['goal_type_convert_leads'] = 'Конвертировать X контактов';
$lang['goal_type_increase_customers_without_leads_conversions'] = 'Увеличение числа клиентов';
$lang['goal_type_increase_customers_without_leads_conversions_subtext'] = 'Конвертированные контакты исключены';
$lang['goal_type_increase_customers_with_leads_conversions'] = 'Увеличение числа клиентов';
$lang['goal_type_increase_customers_with_leads_conversions_subtext'] = 'Включая конвертирование контактов';
$lang['goal_type_make_contracts_by_type_calc_database'] = 'Договоры по типу';
$lang['goal_type_make_contracts_by_type_calc_database_subtext'] = 'Рассчитывается с даты добавления в базу данных';
$lang['goal_type_make_contracts_by_type_calc_date'] = 'Договоры по типу';
$lang['goal_type_make_contracts_by_type_calc_date_subtext'] = 'Рассчитывается исходя из даты начала действия договора';
$lang['goal_type_total_estimates_converted'] = 'Преобразование оценок X ';
$lang['goal_type_total_estimates_converted_subtext'] = 'Будут приниматься только сметы, которые будут преобразованы в счета';
$lang['goal_type_income_subtext'] = 'Доход будет рассчитываться в базовой валюте (без конвертации)';
...
# Backup
$lang['auto_backup_options_updated'] = 'Параметры автобэкапа обновлены';
$lang['auto_backup_every'] = 'Создавать бэкап каждые X дней';
$lang['auto_backup_enabled'] = 'Включено (Требуется крон)';
$lang['auto_backup'] = 'Автобэкап';
$lang['backup_delete'] = 'Бэкап удален';
$lang['backup_success'] = 'Бэкап успешно создан';
$lang['utility_backup'] = 'Бэкап базы данных';
$lang['utility_create_new_backup_db'] = 'Создать бэкап БД';
$lang['utility_backup_table_backupname'] = 'Бэкап';
$lang['utility_backup_table_backupsize'] = 'Размер бэкапа';
$lang['utility_backup_table_backupdate'] = 'Дата';
$lang['utility_db_backup_note'] = 'Примечание: Из-за ограничения времени выполнения и памяти доступной для PHP, резервное копирование очень больших баз данных может оказаться невозможным. Большую базу данных можно забэкапить вручную на сервере с помощью командной строки, или вам нужно будет обратиться за помощью к администратору сервера.';
...
$lang['welcome_top'] = 'Пользователь %s';
...
$lang['add_checklist_item'] = 'Добавить шаг выполнения';
$lang['task_checklist_items'] = 'Шаги выполнения задачи';
...
$lang['utilities_menu_translate_name_help'] = 'Вы можете здесь добавить переведенные строки. Так что, если у сотрудников система имеет другой язык, то по умолчанию названия пунктов меню будут выводиться на языке сотрудников. В ином случае, если строка не существует в файле перевода, то строка будет взята отсюда.';
$lang['utilities_menu_icon'] = 'Иконка';
$lang['active_menu_items'] = 'Активные пункты меню';
$lang['inactive_menu_items'] = 'Неактивные пункты меню';
$lang['utilities_menu_url'] = 'URL';
$lang['utilities_menu_name'] = 'Название';
$lang['utilities_menu_save'] = 'Сохранить';
...
$lang['invoice_activity_payment_made_by_staff'] = 'записал платеж от общего количества <b>%s</b> - %s';
...
$lang['task_billed'] = 'Выставлен счет';
$lang['task_billed_yes'] = 'Счет выставлен';
$lang['task_billed_no'] = 'Счет не выставлен';
...
$lang['not_goal_message_failed'] = 'Нам не удалось достичь цели!<br /> Тип цели: %s
...
$lang['expense_recuring_years'] = 'Год(ы)';
...
$lang['staff_hourly_rate'] = $lang['task_hourly_rate']; // &#37; is for % so the system can confuse for the original fields like %s
...
$lang['view_kanban'] = 'Просмотр Kan Ban';
...
$lang['estimate_invoiced'] = 'Выставление счета';
...
$lang['company_vat_number'] = 'Номер НДС';
...
$lang['save_and_send'] = 'Сохранить & Отправить';
$lang['private'] = 'Частный';
$lang['task_created_at'] = 'Создано %s';
...
$lang['invoice_activity_record_payment_email_to_customer'] = 'Платеж записан, отправлено письмо на: %s';
...
$lang['bcc_all_emails'] = 'BCC (blind carbon copy) - скрытые получатели письма, чьи адреса не показываются другим получателям.';
...
$lang['credit_note_client_note'] = 'Записка';
...
$lang['credits_successfully_applied_to_invoices'] = 'Счета по кредитам успешно применены';
...
$lang['module_deactivate'] = 'Отключить';
...
$lang['show_less'] = 'Показать меньше';
$lang['project_progress_text'] = 'Ход выполнения проекта';
$lang['timer_not_stopped_yet'] = 'Этот таймер еще не остановлен';
$lang['refunds'] = 'Возвраты средств';
$lang['refund'] = 'Возврат';
$lang['refund_amount'] = 'Сумма возврата';
$lang['not_refunds_found'] = 'Возврат не найден';
$lang['refunds_applied_cant_delete_credit_note'] = 'Этот кредитный вексель имеет примененные возвраты, вам нужно сначала удалить возвраты, чтобы удалить кредитный вексель.';

# Version 2.3.2
$lang['create_recurring_from_child_error_message'] = 'Вы не можете установить этот %s как повторяющийся, потому что этот %s является дочерним по отношению к другим повторяющимся %s.';
...
$lang['webhook_created'] = 'Webhook создан успешно.';
$lang['subscriptions_terms_info'] = 'Введите условия, которые будут отображаться клиенту перед подпиской.';
...
$lang['subscription_plan_currency_does_not_match'] = 'Валюта выбранного плана не совпадает с валютой, выбранной ниже.';
$lang['subscription_first_billing_date_info'] = 'Оставьте поле пустым, чтобы использовать дату, когда клиент подписывается на подписку. Это поле должно быть будущей датой, если вы выбрали дату и дата пройдена, но клиент еще не подписан, то будет использоваться дата, когда клиент подпишется.';
$lang['stripe_subscription_select_plan'] = 'Выберите Stripe план';

# Version 2.4.1
$lang['contract_content_permission_edit_warning'] = 'Ваши текущие разрешения не позволяют вам редактировать содержимое контракта. Свяжитесь с администратором для получения разрешения на редактирование контрактов.';
